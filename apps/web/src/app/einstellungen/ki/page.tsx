...
import AiSettingsForm from "@/app/admin/ai-settings/form";
    ...
    <div className="flex flex-col gap-5 p-4 md:p-6 lg:p-8 max-w-3xl">
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "var(--color-muted)" }}>
          Steuere, wie der Chat-Assistent fuer deine Organisation antwortet.
          Dein System-Prompt wird vor jede Antwort gesetzt — zusaetzlich zu den
          fixen Plattform-Regeln (kein Halluzinieren, Quellen zitieren).
        </p>
      </div>
      <AiSettingsForm
