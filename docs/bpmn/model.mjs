  ...
  lanes: [
    // ---------------------------------------------------------------------
    {
      ...
      nodes: [
        ...
        { id: "u_connect", type: "user", name: "Connector verbinden (SharePoint / GDrive / Trello)", col: 0, row: 3 },
    ...
    // ---------------------------------------------------------------------
    {
      ...
      nodes: [
        ...
        { id: "db_entities", type: "store", name: "contacts / companies / projects", col: 8, row: 2 },
